...
| `/lkingest` | `materials_ingested` count in `progress.json` · `[INGEST]` in `courses\{slug}\activity_log.md` · (quiz/exam/practice files) extracted problems in `problem_pool.json` + `[POOL]` log |
